...
import { Search, Globe, Star, BarChart3, Phone, CreditCard, Check, Share2 } from "lucide-react"
    ...
    >
      ...
      <div className="container-padding-x container mx-auto flex flex-col gap-12 md:gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 md:gap-8">
          ...
          <Card className="group relative border-2 border-border/50 bg-card/80 backdrop-blur-md shadow-lg hover:shadow-2xl hover:border-pink-500/50 hover:-translate-y-2 transition-all duration-500 overflow-hidden md:col-span-2 lg:col-span-3">
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-pink-500 via-rose-500 to-pink-500" />
            </div>

            <CardContent className="relative flex flex-col lg:flex-row gap-8 p-8 lg:p-10">
              {/* Left side - Content */}
              <div className="flex-1 flex flex-col gap-6">
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  <div className="relative flex-shrink-0">
                    <div className="absolute inset-0 bg-gradient-to-br from-pink-500/30 to-rose-500/30 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500" />
                    <div className="relative flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-500/20 to-rose-500/20 border-2 border-pink-500/30 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                      <Share2 className="h-8 w-8 text-pink-600 group-hover:text-pink-500 transition-colors duration-500" />
                    </div>
                  </div>

                  <div className="flex flex-wrap gap-2 justify-end">
                    <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-pink-500/20 to-rose-500/20 border border-pink-500/30 text-xs font-bold text-pink-600 whitespace-nowrap shadow-sm group-hover:shadow-md group-hover:scale-105 transition-all duration-300">
                      +250% engagement
                    </div>
                    <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-pink-500/20 to-rose-500/20 border border-pink-500/30 text-xs font-bold text-pink-600 whitespace-nowrap shadow-sm group-hover:shadow-md group-hover:scale-105 transition-all duration-300">
                      Daily posting
                ...
                <div className="flex flex-col gap-3">
                  <h3 className="text-foreground text-2xl font-bold group-hover:text-pink-600 transition-colors duration-300">
                    Social Media Management
                  </h3>
                  <p className="text-muted-foreground text-base leading-relaxed">
                    Build your brand presence across Facebook and Instagram with strategic content, community engagement, and data-driven growth strategies.
                  </p>
                </div>

                <ul className="flex flex-col gap-3 pt-2 border-t border-border/50">
                  <li className="flex items-start gap-3 text-sm text-muted-foreground group/item">
                    <div className="flex-shrink-0 mt-0.5">
                      <div className="relative">
                        <div className="absolute inset-0 bg-pink-500/20 rounded-full blur-sm group-hover/item:blur-md transition-all duration-300" />
                        <Check className="relative h-5 w-5 text-pink-500 group-hover/item:text-pink-600 transition-colors duration-300" />
                      </div>
                    </div>
                    <span className="group-hover/item:text-foreground transition-colors duration-300">
                  ...
                  <li className="flex items-start gap-3 text-sm text-muted-foreground group/item">
                    ...
                    <span className="group-hover/item:text-foreground transition-colors duration-300">
                      Targeted ad campaigns & audience growth
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-muted-foreground group/item">
                    <div className="flex-shrink-0 mt-0.5">
              ...
              <div className="lg:w-80 flex items-center justify-center">
                <div className="relative w-full max-w-xs lg:max-w-none">
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-500/20 to-rose-500/20 rounded-2xl blur-2xl group-hover:blur-3xl transition-all duration-500" />
                  <div className="relative rounded-2xl overflow-hidden border-2 border-pink-500/20 group-hover:border-pink-500/40 transition-all duration-500 group-hover:scale-105">
                    <Image
                      src="/images/social-media-icons.png"
                      alt="Facebook and Instagram social media management"
                      width={320}
                      height={240}
